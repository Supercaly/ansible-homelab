...
|`scsi`| | object | | Dictionary of SCSI disks definitions. Keys must be scsi[n]. Values are dictionaries with keys (storage, size, format, backup, discard, iothread, ssd). |
