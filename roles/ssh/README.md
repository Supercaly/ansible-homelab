...
An Ansible Role that configure a secure SSH server on Linux.

This role applies a set of sensible security defaults to `sshd` and allows customization of authentication, access control, and forwarding options.

## Requirements

Obviously, this role required SSH to be present on the system and accessible by Ansible.
