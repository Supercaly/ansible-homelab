...
|`ssh_allowed_users`| | list | `[]` | List of group names that can exclusively log in using ssh. |
|`ssh_allowed_groups`| | list | `[]` | List of user names that can exclusively log in using ssh.|
