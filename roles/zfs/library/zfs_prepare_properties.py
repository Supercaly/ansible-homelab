...
# https://github.com/aisbergg/ansible-role-zfs/blob/main/library/prepare_zfs_properties.py
...
def main():
    ...
    module_args = dict(
        ...
        type=dict(type="str",
                  default="filesystem",
                  choices=["filesystem", "volume", "zpool", "snapshot"]),
    )
    ...
    try:
        if type_ in ["filesystem", "volume", "snapshot"]:
